...
export default function MerchantPage() {
  ...
  const fetchMetrics = async () => {
    ...
    setError(null)
    try {
      const res = await fetch(`${API_URL}/metrics/merchant/${merchantId}?window=${window}`)
  ...
  const fetchDiagnosis = async () => {
    ...
    setError(null)
    try {
      const res = await fetch(`${API_URL}/diagnosis/merchant/${merchantId}?window=30d`)
      ...
      {metrics && (
        <div className="card">
          ...
          <div className="metrics-grid">
            ...
            <div className="metric-item">
              <div className="metric-value">{metrics.refunds}</div>
            ...
            <div className="metric-item">
              <div className="metric-value">{metrics.refund_rate.toFixed(2)}%</div>
              <div className="metric-label">退款率</div>
            </div>
            <div className="metric-item">
              <div className="metric-value">{metrics.commission_rate.toFixed(2)}%</div>
              <div className="metric-label">佣金率</div>
            </div>
          </div>
        </div>
      )}
